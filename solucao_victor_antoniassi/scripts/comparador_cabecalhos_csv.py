...
def comparar_cabecalhos(df):
    ...
    Returns:
        tuple: Uma tupla contendo:
            ...
            - set: Conjunto de colunas em excesso.
    """
...
def main():
    ...
    """
    diretorio = r'c:\Users\ONNE\Desktop\use_teste_analytics\escolas_csv'
    df_comparacao = pd.DataFrame(columns=["Arquivo", "Status", "Colunas Faltantes", "Colunas em Excesso"])
    ...
    for arquivo in os.listdir(diretorio):
        if arquivo.endswith(".csv"):
            ...
            df_comparacao = pd.concat([df_comparacao, pd.DataFrame({
                ...
                "Colunas em Excesso": [" | ".join(colunas_em_excesso)]
            })], ignore_index=True)

    df_comparacao.to_csv('resultado_comparacao_cabecalhos.csv', sep=";", index=False)
